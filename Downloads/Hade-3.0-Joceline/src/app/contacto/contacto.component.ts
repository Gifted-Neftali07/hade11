...
export class ContactoComponent implements OnInit {
  ...
  onSubmit(): void {
    if (this.contactForm.valid) {
      ...
      const contactoRequest = this.http.post('https://nodejs-firebase-example-master.vercel.app/contacto', this.contactForm.value);
      const contacto2Request = this.http.post('https://nodejs-firebase-example-master.vercel.app/contacto2', this.contactForm.value);
